...
[CustomPropertyDrawer(typeof(UnitID), true)]
public class UnitIDPropertyDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (_config == null)
        {
            _config = AssetDatabase.LoadAssetAtPath<UnitsConfig>("Assets/Configs/UnitsConfig.asset");
            List<string> list = new List<string>();

            foreach (var element in _config.Units)
            {
